    ...
    <div class="container-fluid py-5 px-5">
        <div class="row justify-content-around">
            ...
            <div class="col-8 py-5 rounded-3 px-5" style="background-color: #cee5e6">
                ...
                <form class="text-black" method="post" action="{{ route('topup-commit') }}">
                    @csrf
                    <div class="form-group mb-3">
                        <label for="inputNama">Nominal Top Up</label>
                        <input type="tel" class="form-control" name="nominal" id="inputPhone"
                            placeholder="Minimum : Rp. 10,000" inputmode="numeric"
                            oninput="this.value = this.value.replace(/[^0-9]/g, '')" required />
                    </div>
                    <div class="form-group mb-3">
                        <label for="inputMetode" class="form-label">Metode Pembayaran</label>
                        <select id="inputMetode" name="payment_method" class="form-select">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="password" class="form-control" name="account_password" id="inputkonfirmPassword"
                            required />
                    </div>
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="button" class="btn btn-warning btn-outline-dark mt-5" style="width: 150px"
                            data-bs-toggle="modal" data-bs-target="#exampleModal">Top Up</button>
