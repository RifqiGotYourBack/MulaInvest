    ...
    <div class="d-flex justify-content-around py-4">
      ...
      <div class="col-7 px-5 d-flex justify-content-end">
        <div class="d-flex flex-column text-white" style="font-size: 15px">
          <h5 class="">Menu</h5>
          <a class="text-white link-body-emphasis link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" href="{{ route('beranda') }}"> Beranda </a>
          <a class="text-white link-body-emphasis link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" href="{{ route('tentang') }}"> Tentang </a>
          <a class="text-white link-body-emphasis link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" href="{{ route('investasi') }}"> Investasi </a>
          <a class="text-white link-body-emphasis link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" href="{{ route('aset') }}"> Aset </a>

          <a class="text-white link-body-emphasis text-white link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" href="https://api.whatsapp.com/send/?phone=6285880937403" target="_blank">
            Tanya Kami
          </a>
        </div>
