   ...
   <tbody>
    ...
    <tr>
     ...
     <td>
      ...
      <!-- Modal -->
      <div class="modal fade" id="buttonHapus{{ $investment->InvestmentID }}" tabindex="-1"
       ...
       <div class="modal-dialog">
        <div class="modal-content">
         ...
         <div class="modal-footer">
          ...
          <form action="{{ route('deleteInvestment', $investment->InvestmentID) }}" method="POST">
           @csrf
           @method('DELETE')
      ...
      <div class="modal fade text-start" id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
       <div class="modal-dialog modal-lg">
        <div class="modal-content" style="background-color: #cee5e6">
         ...
         <div class="modal-body my-3 mx-5">
          <form method="POST" action="{{ route('updateInvestment', $investment->InvestmentID) }}">
           @csrf
           @method('PUT')
           <div class="mb-3">
            <label for="InvestmentName" class="col-form-label">Nama Perusahaan</label>
