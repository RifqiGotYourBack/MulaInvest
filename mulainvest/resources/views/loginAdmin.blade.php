...
<div class="container-fluid d-flex justify-content-center" style="height: 611px; background-color: #0198a3">
    ...
    <div class="d-flex flex-column justify-content-center align-items-center bg-white col-5 py-5">
      ...
      <div class="py-3 w-75">
        ...
        <!-- form normal -->
        <form class="pt-3" action="{{ route('admin') }}">
          <div class="mb-3">
          ...
          <div class="mb-3 form-check">
            ...
            <label class="form-check-label text-black-50" for="loginCheck" style="font-size: 10px"
              >Dengan menekan tombol masuk, saya menyetujui <span><a href="#" class="text-black"> Syarat dan Ketentuan Mulainvest</a></span></label
            >
          </div>
        ...
        <!-- form normal -->
        <p class="text-center pt-5" style="font-size: 14px">Belum punya akun? <a href="{{ route('registerAdmin') }}" class="link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Daftar Akun</a></p>
      </div>
    </div>
  </div>
