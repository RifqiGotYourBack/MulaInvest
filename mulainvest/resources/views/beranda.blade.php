...
<div class="py-5">
    ...
    <div class="d-flex p-5 justify-content-center" style="height: 560px">
      <div class="col-7 d-flex flex-column justify-content-center px-3">
        <div class="mb-2">
          <h3 style="font-weight: 600">Mulainvest Siap Bikin Pengalaman Investasi Simple dan Terpercaya</h3>
        </div>
        <div class="mb-5">
          <h5>Awali Investasimu Bersama Mulainvest !</h5>
        </div>
        <div>
          <a class="btn btn-warning btn-outline-dark fw-semibold btn-md" style="width: 300px" href="{{ route('investasi') }}" role="button">Investasi Sekarang!</a>
        </div>
      </div>
      <!-- hero -->
      <div class="col-3">
    ...
    <div class="d-flex py-5 justify-content-center align-items-center" style="background-color: #cee5e6; height: 400px">
      ...
      <div class="col-6">
        ...
        <a class="btn btn-outline-primary fw-semibold" href="{{ route('tentang') }}" role="button" style="width: 200px">lanjut Baca</a>
      </div>
    </div>
    ...
    <div class="d-flex my-5 mx-5 justify-content-center align-items-center bg-secondary-subtle rounded" style="height: 500px">
      ...
      <div class="col-6">
        ...
        <a class="btn btn-outline-primary fw-semibold" href="{{ route('investasi') }}" role="button" style="width: 200px">Lihat Saham</a>
