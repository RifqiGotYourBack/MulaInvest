...
<div class="container-fluid d-flex justify-content-center" style="height: 611px; background-color: #0198a3">
    ...
    <div class="d-flex flex-column justify-content-center align-items-center bg-white col-5 py-5">
      ...
      <div class="w-75">
        ...
        <!-- form normal -->
        <p class="text-center pt-5 pb-3" style="font-size: 14px">Sudah punya akun? <a href="{{ route('loginAdmin') }}" class="link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Masuk </a></p>
      </div>
    </div>
  </div>
